...
public class BizContent {
    ...
    public String toString() {
        ...
        sb.append("outTradeNo='").append(this.out_trade_no).append('\'');
        sb.append(", sellerId='").append(this.seller_id).append('\'');
        sb.append(", totalAmount='").append(this.total_amount).append('\'');
        sb.append(", discountableAmount='").append(this.discountableAmount).append('\'');
        sb.append(", undiscountableAmount='").append(this.undiscountable_amount).append('\'');
        sb.append(", subject='").append(this.subject).append('\'');
        sb.append(", body='").append(this.body).append('\'');
        sb.append(", goodsDetailList=").append(this.goods_detail);
        sb.append(", operatorId='").append(this.operator_id).append('\'');
        sb.append(", storeId='").append(this.store_id).append('\'');
        sb.append(", alipayStoreId='").append(this.alipayStoreId).append('\'');
        sb.append(", terminalId='").append(this.terminalId).append('\'');
        sb.append(", extendParams=").append(this.extend_params);
        sb.append(", timeoutExpress='").append(this.timeout_express).append('\'');
        sb.append('}');
        return sb.toString();
    }
}
